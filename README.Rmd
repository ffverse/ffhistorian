...
`ffhistory` is an R package that retrieves and visualizes fantasy football league history data. Built on top of the excellent [ffscrapr](https://github.com/ffverse/ffscrapr) package, it provides tools to analyze league performance across seasons, track user statistics, and create insightful visualizations of your fantasy football league's history.
...
-   opening [an issue](https://github.com/ffverse/ffhistory/issues/new/choose)
